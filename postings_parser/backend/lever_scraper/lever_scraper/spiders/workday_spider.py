...
class WorkdaySpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for job_element in job_elements:
            ...
            job_id_element = job_element.xpath('.//ul[@data-automation-id="subtitle"]/li')
            ...
            posted_on_element = job_element.xpath('.//dd[@class="css-129m7dg"][preceding-sibling::dt[contains(text(),"posted on")]]')
